...
MODULES["maps"].enoughDamageCutoff = 32; //above this the game will do maps for map bonus stacks
MODULES["maps"].farmingCutoff = 56;     //above this the game will farm.
...
MODULES["maps"].maxMapBonus = 5;       //cap how many maps are run during Want More Damage mode
MODULES["maps"].wantHealthMapBonus = 5;//cap how many maps are run during Want More Health mode
